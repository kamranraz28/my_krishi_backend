                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 16px; color: #333333;">
                                Congratulations! Your booking has been confirmed. We have received your payment. Below is the summary of your payment with bank payment:
                            </p>
                            ...
                            <table cellpadding="10" cellspacing="0" style="width: 100%; border-collapse: collapse; margin-top: 15px;">
                                <thead>
                                    <tr style="background-color: #f2f2f2;">
                                        ...
                                        <th style="border: 1px solid #ddd;">Confirmation Time</th>
