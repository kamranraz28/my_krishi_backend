...
<head>
    <meta charset="UTF-8">
    <title>Online Payment Confirmation - My Krishi</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 16px; color: #333333;">
                                Thank you for your booking. Below is the summary of your project booking(s) with online payment:
                            </p>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($bookings as $index => $booking)
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #ddd;">Paid/Confirmed</td>
                            ...
                            <p style="font-size: 16px; color: #333333; margin-top: 30px;">
                                Please follow My Krishi App to get the project updates.
                            </p>
