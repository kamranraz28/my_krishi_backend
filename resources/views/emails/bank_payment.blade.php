...
<head>
    <meta charset="UTF-8">
    <title>Bank Payment Confirmation - My Krishi</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 16px; color: #333333;">
                                Thank you for your booking. Below is the summary of your project booking(s) with bank payment:
                            </p>
                            ...
                            <p style="font-size: 16px; color: #333333; margin-top: 30px;">
                                We will review your payment and confirm your booking shortly. Please ensure that you have made the payment to the bank.
                            </p>
