...
<head>
    <meta charset="UTF-8">
    <title>Office Payment Cancellation - My Krishi</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 16px; color: #333333;">
                                Your booking has been canceled. You have not paid the Booking Fee within 24 hours. Below is the summary of your cancelled booking:
                            </p>

                            <h3 style="font-size: 18px; color: #2e7d32; margin-top: 30px;">Booking Summary (Cancelled)</h3>
                            ...
                            <table cellpadding="10" cellspacing="0" style="width: 100%; border-collapse: collapse; margin-top: 15px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid #ddd;">Cancelled</td>
                            ...
                            <p style="font-size: 16px; color: #333333; margin-top: 30px;">
                                Please, visit our website to get the updates of the project regularly. If you have any questions, feel free to contact our support team.
                            </p>
